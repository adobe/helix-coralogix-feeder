...
* add coverage and tests ([9a75a0e](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/9a75a0e96f34455c17a7c05e4edcdd70b75dd138))
* add events ([c6b94ad](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/c6b94ad5ffee7d738bda62c190019c10116011f4))
* add gcloud-setup ([825fa79](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/825fa7945cd1595936f738fbeec8a23ffe47cdc8))
* add level, message and timestamp ([397ad37](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/397ad3736ad4d1867eb6f9b604d907dc4e6d550d))
* add message ([6a921f4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/6a921f454ec452e3ac43d997486d7ffd2d37d27f))
* add more information ([67f82a7](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/67f82a7048a4205604998923070ef4b39f71830c))
* add retry delays ([#21](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/21)) ([a6e8be4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/a6e8be4640036bc8c3489ae908adced974782698))
* add stack for unexpected error ([169e99c](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/169e99c6e845dd9095a00d773ae37cae0251fd3a))
* allow $LATEST as function version ([2c771c4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/2c771c492c63f465b1ea67d549ed4f691bdcc4d3))
* assert.fail is wrong ([349ff7a](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/349ff7a5b28060b240a624c7bb654c61ac139353))
* catch outer errors ([366258b](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/366258b101e7bfa7e8e616c4f0e0a6847d4c3780))
* check CORALOGIX_API_KEY is set ([#34](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/34)) ([f86fe46](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/f86fe46705413a9a1ae77b057e74fd0aeef52245))
* circleci context ([17c38e1](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/17c38e10d41b32480c392459e737b30b38048a52))
* **deps:** update adobe fixes ([#104](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/104)) ([5d26d9c](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/5d26d9cc26ceffca5aef8befc1f409e481e42db6))
* **deps:** update adobe fixes ([#153](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/153)) ([b38beb4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/b38beb47898e82770255af3c9831be72b9cce01a))
* **deps:** update adobe fixes ([#28](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/28)) ([647f92a](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/647f92a3f2dad18242f14c309c6a78ec56c87dd1))
* **deps:** update adobe fixes ([#47](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/47)) ([f984e86](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/f984e86b5c8c0cb5423125a1cbaff63445c3a523))
* **deps:** update adobe fixes ([#59](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/59)) ([c621d81](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/c621d814c71aff213bd5bb621a08fd04307f8b6d))
* **deps:** update adobe fixes ([#71](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/71)) ([7a2a927](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/7a2a92706f0e82150a2c2a4f9079944ed6d57219))
* **deps:** update adobe fixes ([#75](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/75)) ([4ca6a7f](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/4ca6a7f17a88a7027faa45b3d178f69e80b08132))
* **deps:** update adobe fixes ([#87](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/87)) ([253c5bc](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/253c5bc3890f7492bd3fec66dc8d8d62343d9f0e))
* **deps:** update adobe fixes ([#88](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/88)) ([43f6e1f](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/43f6e1f96c96a9505fc6df2ffb744c503c0fecde))
* **deps:** update adobe fixes ([#99](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/99)) ([1c060d0](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/1c060d08be93c949384c8511addfc24d0045d876))
* **deps:** update adobe major ([5a129c9](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/5a129c985d8d70698ccf6e0fee486fa0571f8210))
* **deps:** update dependency @adobe/fetch to v4.0.10 ([#90](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/90)) ([8bd4e19](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/8bd4e1928705cbe50db00b6e6ea5edd448b2a44e))
* **deps:** update dependency @adobe/fetch to v4.1.1 ([#169](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/169)) ([043f35f](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/043f35f2fb24f39ed8360485e3d56b082a6487e3))
* **deps:** update dependency @adobe/helix-deploy to v7.3.11 ([#38](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/38)) ([d7aae39](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/d7aae399bb9a97ad918a541fddbcf4622a44b625))
* **deps:** update external fixes ([#40](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/40)) ([27dab6d](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/27dab6de39c961e56c28350ee0a96067d72c8945))
* include logEntries when status code reports 400 ([8ec6894](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/8ec68948724b301cb9bc4ab1147056a4f741f8e7))
* initial commith ([35c91f7](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/35c91f78fd318d85655004489ececfe77efa9d66))
* log exception with stack ([b0734c0](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/b0734c0331f0dbe9704707a31522bd1eafcd1940))
* logging last 4 letters of CORALOGIX_API_KEY ([e961487](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/e961487aac2a4bf0e3f168b13bd41ff29080d82e))
* lower case log level ([e6842b3](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/e6842b38f9c50ef7d825f9c1b77bbf5dd89165f0))
* message with no log level should default to `INFO` ([7092ecf](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/7092ecf575086fa72f0ab81535babde1d667079b))
* needs specific role ([fa80b7f](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/fa80b7fb81836e6bbb1a19d841ccdf4700d34715))
* provide more details when sending fails ([f020426](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/f020426ad69e9fb2ef90f16d8b8e8d3c55cc9a48))
* remove coralogix tagging ([a4892d4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/a4892d476d803516b4aceab82726f2a637378250))
* remove linefeeds at the end ([#4](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/4)) ([d648e27](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/d648e270aa573673f109ba8cae2e7a3e1f1735ee))
* remove with (console) ([5c5fafd](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/5c5fafd5e1852b82670b84ab25c833a591f150e0))
* repo path ([817e11d](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/817e11d8fc4c927b3b32f6bf123483c28e9001a5))
* send unprocessed messages to DLQ ([#18](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/18)) ([beb6cb8](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/beb6cb81e0d10c846cdcabc927281348c5614a8f))
* status should be NO CONTENT ([cc49283](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/cc492832848e7e7b102a131af23f8e3dd71f7970))
* update helix-deploy to 9.0.3 ([#52](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/52)) ([a76dd73](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/a76dd73f4fd8f495ecf047b6a4bbc1a182449a03))
* update semantic-release-coralogix to 1.1.15 ([377e1dd](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/377e1ddbc29d987882e70360aa435e64d42b8ea2))
* update to @adobe/semantic-release-coralogix@1.1.16 ([1cfdd36](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/1cfdd368d021296365f98c3f104d2293013ad37d))
* use alias in function name ([#2](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/2)) ([8a6d392](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/8a6d392d494ac5f33e4cdcc553961696e8bfcfe6))
* use invocationId instead of requestId ([d2504f9](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/d2504f972866ce5f82cfeede917b36276908d6cb))
* use node 18 ([#37](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/37)) ([68d941b](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/68d941b5992486e4c7ed4c60ae2bac8bbe99b0f9))
* when no log messages remain, don't send ([40f076f](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/40f076f3da05c2efecd7dcfb659563211ca97ee4))


### Features

* include logstream for better reverse lookup ([#10](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/10)) ([7ca0f5a](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/7ca0f5ad46b5d2db40fea3843fd20c29a6fce3e5))
* mapped subsystem ([#188](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/188)) ([#189](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/189)) ([a19c0e9](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/a19c0e961739090b2a38a058d8fd04adb52f3ad0))
* support custom coralogix subsystem name ([#68](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/68)) ([92c3992](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/92c399227f4fe1353c609d99a006fffc464f1258))
* use CORALOGIX_LOG_LEVEL ([#8](https://github.com/adobe-rnd/spacecat-coralogix-feeder/issues/8)) ([fa10e3b](https://github.com/adobe-rnd/spacecat-coralogix-feeder/commit/fa10e3b7c6f2b2a32e28a4da76bdcb731747d719))
